...
export default function SingleProductPage() {
  ...
  const updateMetaTags = (product) => {
    ...
    document.title = `${product.title} - TecnoStyle`;
    ...
    updateTwitterTag('twitter:description', product.description);
    updateTwitterTag('twitter:image', product.thumbnail || product.images?.[0]);
  };
  ...
  const restoreOriginalMetaTags = () => {
    ...
    updateMetaTag('og:title', 'TecnoStyle Eshop');
    updateMetaTag('og:description', 'API TecnoStyle Eshop');
    updateMetaTag('og:image', 'https://i.imgur.com/w69D8Y0.png');
  ...
  useEffect(() => {
    ...
    // Cleanup: restaurar meta tags originales cuando se desmonta el componente
    return () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Contenido principal con botón de volver debajo del navbar */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Botón de volver - Posicionado debajo del navbar */}
        <div className="mb-6">
          <button
            onClick={() => navigate('/products')}
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
          >
            <svg
