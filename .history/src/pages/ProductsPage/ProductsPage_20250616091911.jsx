...
export default function ProductsPage() {
  ...
  // Corregir el nombre del handler para que coincida con el prop onInput del MultiRangeSlider
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
              ...
              <div className="mb-8">
                ...
                >
                  {({ open }) => (
                    <>
                      <div className="relative">
                        <Listbox.Button className="relative w-full cursor-default rounded-xl border border-gray-300 bg-white py-3 pl-3 pr-10 text-left shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-200">
                                ...
                                className={({ active }) =>
                                  classNames(
                                    active
                                      ...
                                      : 'text-gray-900',
                                    'relative cursor-default select-none py-2 pl-3 pr-9 hover:bg-primary-50 transition-colors duration-150'
                                  )
                                }
                                value={category}
                              >
          ...
          <main className="lg:col-span-3 mt-8 lg:mt-0">
            ...
            {/* Products Grid - Mejorado el espaciado */}
